...
import { 
  Zap, Trophy, Users, CheckCircle, 
  ArrowRight, Play, Star, Code, 
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 selection:bg-indigo-100">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-slate-600 mb-10 max-w-lg leading-relaxed">
              Beautifully designed quizzes for developers, students, and teams. From AI-generated coding challenges to interactive trivia.
            </p>
            ...
            <div className="mt-12 flex items-center gap-4">
              ...
              <div className="text-sm">
                ...
                <p className="text-slate-500 font-medium">Joined by 50,000+ quiz takers</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative bg-slate-900 rounded-3xl p-4 shadow-2xl border border-slate-800">
              ...
              <div className="flex items-center justify-between mb-4 px-2">
                ...
                <div className="text-[10px] text-slate-500 font-mono">QUIZ_SESSION: ACTIVE</div>
              </div>
              {/* Question UI */}
              <div className="p-6 bg-slate-800/50 rounded-xl border border-slate-700">
                <div className="text-emerald-400 font-mono text-sm mb-2">$ question --current</div>
                <h3 className="text-xl font-semibold text-white mb-6">Which React hook is used for side effects?</h3>
                <div className="space-y-3">
                  {['useState', 'useEffect', 'useMemo'].map((opt, i) => (
                    <div key={opt} className={`p-4 rounded-lg border flex justify-between items-center ${i === 1 ? 'bg-indigo-500/10 border-indigo-500 text-indigo-300' : 'bg-slate-800 border-slate-700 text-slate-400'}`}>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">Everything you need to master concepts</h2>
            <p className="text-slate-500">Powerful features to help you learn faster and track progress.</p>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto bg-slate-900 rounded-[3rem] p-12 text-center relative overflow-hidden">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 relative z-10">Stop guessing. Start knowing.</h2>
          <p className="text-slate-400 text-lg mb-10 max-w-xl mx-auto">
            Join the elite community of learners today. No credit card required to start your first session.
          </p>
